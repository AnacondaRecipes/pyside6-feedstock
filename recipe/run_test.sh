...
test -f ${PREFIX}/PySide6/include/pyside.h || (echo "FATAL: Failed to find PySide6/pyside.h" && exit 4)
test -f ${PREFIX}/shiboken6/include/shiboken.h || (echo "FATAL: Failed to find shiboken6/shiboken.h" && exit 5)
